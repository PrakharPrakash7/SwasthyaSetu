...
const TopDoctors = () => {
    ...
    // Using context to access doctors data
    // This allows you to use the doctors data without importing it directly avoid prop drilling Any child component can access the doctors data using useContext(AppContext).
    const {doctors} = useContext(AppContext);


  return (
    <div className='flex flex-col items-center my-16 text-gray-800 md:mx-10 gap-4'>
      <h1 className='text-3xl font-medium'>Here are The Top Doctors You can Book</h1>
