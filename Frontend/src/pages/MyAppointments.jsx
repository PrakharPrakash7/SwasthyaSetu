...
const MyAppointments = () => {
  ...
  return (
    <div>
     ...
     {doctors.slice(0,3).map((item,index)=>(
      ...
      <div>
        <img className='w-32 bg-purple-50' src={item.image}/> 
      </div>
  ...
  <div className='flex-1 text-sm text-zinc-600'>
        ...
        <p  className='text-sm mt'><span className='text-sm text-neutral-700 font-medium '>Date & Time :</span> 25 July,2025 | 8:30 PM</p>
 </div>
        <div></div>
