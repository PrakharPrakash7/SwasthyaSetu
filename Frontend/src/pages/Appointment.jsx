    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div>
          ...
          <img className='bg-primary w-full sm:max-w-80 rounded-lg' src={docInfo.image} />
          
        </div>

        <div className='flex-1 border border-gray-600 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          {/* Doctors information name degree and experince */}
          ...
          <span className='text-gray-900'> {currencySymbol}{docInfo.fees}</span>
        </p>
        </div> 
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <div className='flex gap-3 items-center w-full overflow-x-scroll mt-4'>
          ...
          <p className='text-sm text-gray-500'>Note: Please arrive 15 minutes before your appointment time.</p>
