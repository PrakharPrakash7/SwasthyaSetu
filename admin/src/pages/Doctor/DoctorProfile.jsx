    ...
    <div>
      <div className='flex flex-col gap-4 m-5 '>
        ...
        <div className='flex items-center gap-2 mt-1 text-gray-600'>
          ...
          <button className='py-.5 px-2 border text-xs rounded-full'>{profileData.experience}</button>
        </div>
          ...
          <div className='flex gap-2 py-2'>
            <p>Address:</p>
            <p className='text-sm'>
            {isEdit ? <input type='text' value={profileData.address.address1} onChange={(e) => setProfileData(prev => ({...prev, address: {...prev.address, address1: e.target.value}}))} /> : profileData.address.address1}
            <br/>
            {isEdit ? <input type='text' value={profileData.address.address2} onChange={(e) => setProfileData(prev => ({...prev, address: {...prev.address, address2: e.target.value}}))} /> : profileData.address.address2}
            </p>
          </div>
